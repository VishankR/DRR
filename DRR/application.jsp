...
@-webkit-keyframes slide {
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="jumbotron text-center" id="home">
        ...
        <p>Basic Detail</p> 
        <form  name="RegForm" action="/action_page.php" method="post" onsubmit="return validateForm()" class="form-inline">
            ...
            <div class="form-group">
             ...
             <br>
             <br>
            <button type="submit" class="btn btn-default" href="www.google.com" >Submit</button>
        </form>
        <br>
        <br>
        <br>
           ...
           <h2 class="text-center">CONTACT</h2>
              <div class="row">
                <div class="col-sm-5">
                      ...
                      <p><span class="glyphicon glyphicon-map-marker"></span> city,state</p>
                      <p><span class="glyphicon glyphicon-phone"></span> Phone no.</p>
